...
class Administrator : Uzivatel    // Třída Administrator dědí od třídy Uzivatel atributy (jmeno, email, heslo) a metody (PrihlasitSe, OdhlasitSe), které už není potřeba znovu implementovat
{
