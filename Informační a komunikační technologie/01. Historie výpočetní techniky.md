...
definice: počítač= stroj pro zpracovávání informací podle předem daného programu. Základní rozdělení podle typu signálu s kterým pracuji : analogové, číslicové (digitální), hybridní.
