...
- **PROM** – Prázdná paměť, lze ji naprogramovat po výrobě (pouze 1x)
- **EPROM** – Prázdná paměť, lze ji vymazat UV světlem a naprogramovat znovu
- **EEPROM** – Prázná paměť, lze ji vymazat přivedeným napětí napětí a naprogramovat znovu
