...
- Rozhraní
	...
	- SCSI / servery - již se téměř nepoužívá
	- SAS / servery - již se používá málo
- Velikost
	- 2.5" - notebooky
	- 3.5" - desktopové a tower skříně, skříně do racku
	- 1.8" - pro malá přenosná zařízení
...
## Disketová mechanika / - již se téměř nepoužívá, neperspektivní
